                        	...
                        	self.blogcomment = {
                          	...
                          	self.getSelectedBlog = function getBlog(id){
                          		...
                          		self.addrating=function()
                          		{
                          			...
                          			BlogService.addrating(self.ratingvalue)
                          			.then(
                          					self.fetchAllBlogComments,
                          					function(errResponse){
                          						console.error("Error while rating BlogComment");
                          					}); 
                          		}
                          		...
                          		self.addcomment = function(id,comment){
                              		{
                              			...
                              			self.commentBlog(self.blogcomment,id,comment);
                              		}
                              		};
                              		
                              		self.commentBlog = function(blogcomment,id,comment){
                              			console.log("comment "+blogcomment.bcomment+" for the blog "+id+" actual comment "+comment)
                              			BlogService.commentBlog(blogcomment,id,comment)
                              			.then(
                              					self.fetchAllBlogComments,
                              					function(errResponse){
